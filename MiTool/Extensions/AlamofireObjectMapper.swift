...
//        if let result = try? jsonResponseSerializer.serialize(request: request, 
//                                                              response: response,
//                                                              data: data,
//                                                              error: nil) {
//            
...
//    }
//    
//    internal static func newError(_ code: ErrorCode, 
...
//    internal static func checkResponseForError(request: URLRequest?, 
//                                               response: HTTPURLResponse?,
//                                               data: Data?,
//                                               error: Error?) -> Error? {
//        if let error = error {
...
//    public static func ObjectMapperSerializer<T: BaseMappable>(_ keyPath: String?, 
//                                                               mapToObject object: T? = nil,
//                                                               context: MapContext? = nil) -> MappableResponseSerializer<T> {
//        
//        return MappableResponseSerializer(keyPath, 
//                                          mapToObject: object,
//                                          context: context, serializeCallback: {
//            request, response, data, error in
//
//            let JSONObject = processResponse(request: request, 
//                                             response: response,
//                                             data: data,
//                                             keyPath: keyPath)
//            
...
//    public static func ObjectMapperImmutableSerializer<T: ImmutableMappable>(_ keyPath: String?, 
//                                                                             context: MapContext? = nil) -> MappableResponseSerializer<T> {
//        
//        return MappableResponseSerializer(keyPath, 
//                                          context: context,
//                                          serializeCallback: { request, response, data, error in
//            
//            let JSONObject = processResponse(request: request, 
//                                             response: response,
//                                             data: data,
...
//     */
//    @discardableResult
//    public func responseObject<T: BaseMappable>(queue: DispatchQueue = .main, 
//                                                keyPath: String? = nil,
//                                                mapToObject object: T? = nil,
...
//    
//    @discardableResult
//    public func responseObject<T: ImmutableMappable>(queue: DispatchQueue = .main, 
//                                                     keyPath: String? = nil,
//                                                     mapToObject object: T? = nil,
//                                                     context: MapContext? = nil,
//                                                     completionHandler: @escaping (AFDataResponse<T>) -> Void) -> Self {
...
//    public static func ObjectMapperArraySerializer<T: BaseMappable>(_ keyPath: String?, 
//                                                                    context: MapContext? = nil) -> MappableArrayResponseSerializer<T> {
//        return MappableArrayResponseSerializer(keyPath,
//                                               context: context,
//                                               serializeCallback: {
//            request, response, data, error in
//            
...
//    
//    /// ImmutableMappable Array Serializer
//    public static func ObjectMapperImmutableArraySerializer<T: ImmutableMappable>(_ keyPath: String?, 
//                                                                                  context: MapContext? = nil) -> MappableArrayResponseSerializer<T> {
...
//     */
//    @discardableResult
//    public func responseArray<T: BaseMappable>(queue: DispatchQueue = .main, 
//                                               keyPath: String? = nil, 
//                                               context: MapContext? = nil,
//                                               completionHandler: @escaping (AFDataResponse<[T]>) -> Void) -> Self {
...
//     */
//    @discardableResult
//    public func responseArray<T: ImmutableMappable>(queue: DispatchQueue = .main, 
//                                                    keyPath: String? = nil, context: MapContext? = nil,
//                                                    completionHandler: @escaping (AFDataResponse<[T]>) -> Void) -> Self {
